...
const (
	...
	ADMIN5_CRYPTO_PATH = "./crypto-config/node1/admin/admin5"
	ADMIN1_NAME        = "admin1"
	ADMIN2_NAME        = "admin2"
	ADMIN3_NAME        = "admin3"
	ADMIN4_NAME        = "admin4"
...
func TestAddPkUsersFirstly(t *testing.T) {
	...
	wantNum := 1
	wantExisted := true
	SetAdminPkUser(ADMIN1_NAME, "./crypto-config/node1/admin/admin1")
	...
	wantNum = 2
	wantExisted = true
	SetAdminPkUser(ADMIN2_NAME, "./crypto-config/node1/admin/admin2")
	...
	wantNum = 3
	wantExisted = true
	SetAdminPkUser(ADMIN3_NAME, "./crypto-config/node1/admin/admin3")
	...
	wantNum = 4
	wantExisted = true
	SetAdminPkUser(ADMIN4_NAME, "./crypto-config/node1/admin/admin4")
	...
	wantNum = 5
	wantExisted = true
	SetAdminPkUser(ADMIN5_NAME, "./crypto-config/node1/admin/admin5")
...
func TestAdmin1SDKConf(t *testing.T) {
	...
	gotSDKConfPath, err := SetSDKConf("chain1", ADMIN1_CRYPTO_PATH, ADMIN1_NAME, "./sdk-configs", nodeConf)
	...
	gotSDKConf, err := ReadSDKConf("./sdk-configs", ADMIN1_NAME)
	if err != nil {
...
func TestAdmin2SDKConf(t *testing.T) {
	...
	gotSDKConfPath, err := SetSDKConf("chain1", ADMIN2_CRYPTO_PATH, ADMIN2_NAME, "./sdk-configs", nodeConf)
	...
	gotSDKConf, err := ReadSDKConf("./sdk-configs", ADMIN2_NAME)
	if err != nil {
		t.Errorf("read sdk config failed")
	}
...
func TestAdmin3SDKConf(t *testing.T) {
	...
	gotSDKConfPath, err := SetSDKConf("chain1", ADMIN3_CRYPTO_PATH, ADMIN3_NAME, "./sdk-configs", nodeConf)
	...
	gotSDKConf, err := ReadSDKConf("./sdk-configs", ADMIN3_NAME)
	if err != nil {
		t.Errorf("read sdk config failed")
	}
...
func TestAdmin4SDKConf(t *testing.T) {
	...
	gotSDKConfPath, err := SetSDKConf("chain1", ADMIN4_CRYPTO_PATH, ADMIN4_NAME, "./sdk-configs", nodeConf)
	...
	gotSDKConf, err := ReadSDKConf("./sdk-configs", ADMIN4_NAME)
	if err != nil {
		t.Errorf("read sdk config failed")
	}
...
func TestEVMAddr(t *testing.T) {
	keyPemStr, err := CalcEVMAddr("./crypto-config/node1/admin/admin1", "admin1")
	if err != nil {
